...
A powershell script to scan **a users entire github repos** with trufflehog for Windows 11+, with a Python dashboard to display results. If secrets are found, they are labeled with a red color.
